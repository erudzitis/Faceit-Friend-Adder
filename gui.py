...
MainLayoutColumn = [
    [pysg.Input(enable_events=True, border_width=0, key="-MINIMUMINVENTORYVALUE-")],
    [pysg.Input(enable_events=True, border_width=0, key="-FACEITLIVEMATCHLIMIT-")],
    [pysg.Input(enable_events=True, border_width=0, key="-TARGETUSERCOUNTRYLIST-")],
    [pysg.Button("Start", expand_x=True, border_width=0, key="-STARTFACEITADDER-")]
]

OutputLayoutColumn = [
    [pysg.Multiline(size=(1, 5), expand_x=True, disabled=True, autoscroll=True, key="-OUTPUTLOG-")],
    [pysg.StatusBar("", key="-OUTPUTPROGRESS-")]
]
